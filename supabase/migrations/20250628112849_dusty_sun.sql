/*
  # Create Core Tables for Quran Memorization App

  1. New Tables
    - `surahs` - Complete list of all 114 Quran chapters
    - `ayahs` - Individual verses with Arabic text, translation, transliteration  
    - `memorized_ayahs` - User memorization tracking
    - `user_progress` - Streak count and last memorized verse

  2. Security
    - Enable RLS on all tables
    - Add policies for public read access to surahs/ayahs
    - Add policies for user-specific access to personal data
