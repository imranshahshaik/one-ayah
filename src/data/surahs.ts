...
export const surahs: Surah[] = [
  ...
  { number: 60, name: "الممتحنة", englishName: "Al-Mumtahinah", englishNameTranslation: "She that is to be examined", numberOfAyahs: 13, revelationType: "Medinan" },
  ...
  { number: 113, name: "الفلق", englishName: "Al-Falaq", englishNameTranslation: "The Dawn", numberOfAyahs: 5, revelationType: "Meccan" },
